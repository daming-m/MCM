...
|----------|------|--------|----------|----------|----------|----------|
| 无人机管理 | 开发中 | @dev | [无人机管理需求](01-product-specs/drone-management-spec.md) | [无人机管理设计](02-design-docs/drone-management-design.md) | [无人机 API](04-api-docs/drone-api.md) | 2026-05-29 |
| 安全认证 | 开发中 | @dev | — | [Shiro 配置](config/ShiroConfig.java) | — | 2026-05-29 |
